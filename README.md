...
* failing that, use the tag, if nothing else applies
* failing that, use any unknown label type
* finally, fall back to `"Unlabeled"` if no label can be determined
